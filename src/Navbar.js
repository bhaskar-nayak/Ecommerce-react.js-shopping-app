...
function Navbar(){
  ...
  <div className="container-fluid">
    <Link className="navbar-brand" to={"/"}><span className="text-center">Bhaskar</span></Link>
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li className="nav-item">
          <Link className="text-decoration-none" to="cart"><a className="nav-link"><span className="me-2">Cart{cartCount}</span>< FontAwesomeIcon icon={faShoppingCart} /></a></Link>
        </li>
      </ul>
